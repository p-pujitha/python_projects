...
def test_range_allocates_memory():
    try:
        ...
        print oe # what error do you get when you allocate 100 billion ints?->prints range() result has too manyitems
        assert True
...
def test_collapse_generator():
    assert 'generator' == demo_generator_to_list(demo_range(4))
