...
def test_tuple_unpacking():
    ...
    try:
        ...
        print ve  # observe what is printed here. - too many values to unpack
        assert True
...
def min_max(input):
    ...
    """
    return list((min(input), max(input)))  # write a line of code to return containing min and max
...
-   tuple usage
-   various representaions of sequences
-   Usage of list(), min(), max()
"""
