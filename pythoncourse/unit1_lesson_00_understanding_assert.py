...
expression. It takes the form assert <expr>, <optional message>. If <expr> evaluates to False an
 AssertionError is raised with
...
- what is the importance of assert in the python
- using of assert in our statements in python
"""
