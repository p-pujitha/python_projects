...
-with classes we can define our own data types using the existing data types
-we can create run time variables for the classes
-there are unbound and bound methods, bound- object.method(...), unbound- class.method(object,...)
"""