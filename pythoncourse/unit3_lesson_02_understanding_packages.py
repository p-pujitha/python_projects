...
def test_package_basic_import():
    ...
    try:
        ...
        print ae  #prints 'module' object has no attribute 'module1'
...
def test_package_import_failure():
    ...
    #why_it_failed #= No module named package2 in sys.modules no module like package2
...
-.__doc__ and packages contain both subpackages and modules
"""
