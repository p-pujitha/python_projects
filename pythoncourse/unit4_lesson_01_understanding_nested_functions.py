...
def test_inner_func_scope():
    ...
    try:
        ...
        print ne #it prints name 'inner_func' is not defined
    ...
    try:
        ...
        print ae  # function object has no attribute 'inner_func'
...
- how to return the inner function and binding the functions
