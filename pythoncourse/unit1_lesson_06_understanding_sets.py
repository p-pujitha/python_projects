...
def test_set_length():
    ...
    assert 1 == len(fruits)  #are duplicates removed? yes
...
def common(input1, input2):
    ...
    """
    return set(set(input1) & set(input2)) # write a single line of code
...
-   Using set()
-   Differences between sets, lists, tuples, dicts
-   empty set cannot be represented as {} but can be represented as set([])
"""
